...
useEffect(()=>{
  if(genre!==""){
  axios.post('https://movies-88q6.onrender.com/search',{genre:genre}).then(response=> 
...
await axios.post('https://movies-88q6.onrender.com/search',{data:x}).then(response=>setData(response.data[0]));
