...
let login = localStorage.getItem("login")
  login ==="true"?navegate('/'):""
    ...
    function sendData(e){
      e.preventDefault()
    axios.post('https://backend-movielist.onrender.com/login',{name:name,password:pass}).then(response=>addData(response.data)).catch(err=>setErrs(['Nome ou senha invalidos']))
